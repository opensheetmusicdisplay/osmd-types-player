...
import { default as Dictionary_2 } from 'typescript-collections/dist/lib/Dictionary';
import * as SoundfontPlayer from 'soundfont-player';
import { default as Vex_2 } from 'vexflow';
...
declare class AbstractTimingSource implements ITimingSource {
...
export declare interface AutoBeamOptions {
...
declare class CursorPosChangedData {
...
export declare interface DegreesInfo {
    adds?: string[];
    alts?: string[];
    subs?: string[];
}
...
export declare const FontStyleString: Object;
...
declare class GraphicalWavyLine extends GraphicalObject {
 ...
 */
export declare interface IAfterSheetReadingModule {
    calculate(musicSheet: MusicSheet): void;
}

export declare interface IAudioMetronomePlayer {
    /**
...
export declare interface IAudioPlayer<TSoundFont> {
    ac: AudioContext;
...
export declare interface IControllerOutputListener {
    outputChanged(directlySet: boolean, currentValue: number, expectedValue: number): void;
}

export declare interface ICurveOptions {
    spacing: number;
    thickness: number;
    x_shift: number;
    y_shift: number;
...
export declare interface IDisplayInteractionListener {
    displaySizeChanged(width: number, height: number): void;
    positionTouched(relativePositionX: number, relativePositionY: number): void;
    positionDoubleTouched(relativePositionX: number, relativePositionY: number): void;
    mouseDown(relativePositionX: number, relativePositionY: number, activateZoomOnRightMouseButton: boolean): void;
...
export declare interface IGraphicalSymbolFactory {
...
export declare interface IInstrument {
    Id: number;
    Audible: boolean;
    Solo: boolean;
    Mute: boolean;
...
export declare interface IMessageViewer {
    MessageOccurred: any;
}
 ...
 */
export declare interface IOSMDOptions {
...
export declare interface IPlaybackListener {
    cursorPositionChanged(timestamp: Fraction, data: CursorPosChangedData): void;
    pauseOccurred(o: object): void;
    selectionEndReached(o: object): void;
    resetOccurred(o: object): void;
...
export declare interface IPlaybackParametersListener {
...
export declare interface IQualityFeedbackTone {
    ParentNote: Note;
    TimingScore: number;
    PitchScore: number;
...
export declare interface IRepetition {
...
export declare interface ISettableInstrument extends IInstrument {
    Audible: boolean;
    Solo: boolean;
    Mute: boolean;
    Visible: boolean;
...
export declare interface ISqueezable {
    /**
...
export declare interface IStafflineNoteCalculator {
...
export declare interface ITextMeasurer {
    fontSize: number;
...
export declare interface ITimingSource {
    Settings: PlaybackSettings;
    setBpm(bpm: number): void;
    setTimeAndBpm(timestamp: Fraction, bpm: number): void;
...
export declare interface ITransposeCalculator {
...
export declare interface IUserDisplayInteractionListener {
    userDisplayInteraction(relativePosition: PointF2D, positionInSheetUnits: PointF2D, type: InteractionType): void;
}

export declare interface IVoiceMeasureReadPlugin {
...
export declare interface IZoomView {
    /**
...
export declare abstract class MusicSystem extends GraphicalObject {
     ...
     */
    protected labels: Dictionary_2<Instrument, GraphicalLabel>;
...
export declare interface NoteIndexToPlacementEnum {
...
export declare interface TremoloInfo {
...
export declare abstract class VexFlowBackend {
    ...
    abstract getContext(): Vex_2.IRenderContext;
...
export declare class VexFlowConverter {
     ...
     * @type {[alterationsNo: number]: string; }
     ...
     export declare class VexFlowInstrumentBracket extends GraphicalObject {
          ...
          */
         draw(ctx: Vex_2.IRenderContext): void;
         /**
     ...
     export declare class VexFlowMeasure extends GraphicalMeasure {
          ...
          * @param ctx
          */
         draw(ctx: Vex_2.IRenderContext): Node;
         format(): void;
     ...
     declare class WavyLine extends AbstractExpression {
         constructor(placement: PlacementEnum);
         ParentStartMultiExpression: MultiExpression;
         ParentEndMultiExpression: MultiExpression;
     }
